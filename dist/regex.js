...
function convertToolIntoRegexString(tool) {
    let regexString = " ";
    regexString += escapeRegExp(tool.name);
    return regexString;
}
exports.convertToolIntoRegexString = convertToolIntoRegexString;
function convertCommandIntoRegexString(robotName, tool, cmd) {
...
exports.convertCommandIntoRegexString = convertCommandIntoRegexString;
